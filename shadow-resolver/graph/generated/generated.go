...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Todo.working":
		...
		args, err := ec.field_Todo_working_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Todo.Working(childComplexity, args["in"].(*int)), true
...
func (ec *executionContext) field_Todo_working_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *int
...
func (ec *executionContext) _Query_todo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOTodo2ᚖgithubᚗcomᚋmatiasanayaᚋgqlgenᚑscratchᚋshadowᚑresolverᚋgraphᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Todo_working(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Todo_working_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
...
func (ec *executionContext) marshalOTodo2ᚖgithubᚗcomᚋmatiasanayaᚋgqlgenᚑscratchᚋshadowᚑresolverᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
